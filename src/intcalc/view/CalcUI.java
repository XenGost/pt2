...
import intcalc.main.IntCalcApplication;
...
public class CalcUI {
    ...
    public static final String ERROR_ARITHMETIC_PATTERN
            = "Arithmetic Error: %s";
    public static final String ERROR_TOKEN_PARSE_PATTERN =
    ...
    public void run() {
        ...
        output.print(' ');
        try {
            int[] init=application.getStateManager().getState();
            String initString = Arrays.toString(init);
            output.println(initString);
        ...
        while (cont) {
            ...
            try {
                ...
                output.print(' ');
                String rezultString = Arrays.toString(result);
                output.println(rezultString);
                output.flush();
    ...
    private int[] readInt() throws IOException {
        while (true) {
            ...
            try {
                return Arrays.stream(token.split(" ")).mapToInt(Integer::parseInt).toArray();
